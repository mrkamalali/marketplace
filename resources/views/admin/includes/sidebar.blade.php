        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item open">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('site.languages.create') }}" data-i18n="nav.dash.crypto">{{ __('site.addLang') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('main-cats.create') }}" data-i18n="nav.dash.crypto">أضافه جديد</a>
                    </li>
                </ul>
            </li>
