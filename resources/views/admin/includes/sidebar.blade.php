        ...
        <ul class="navigation navigation-main " id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ __('site.siteLanguages') }}</span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{ App\Language::count() }}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ url('admin/languages') }}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('site.languages.create') }}"
                           data-i18n="nav.dash.crypto">{{ __('site.addLang') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        ...
                        {{ App\MainCategory::parentCategory()->count() }}
                    </span>
                </a>
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('main-cats.create') }}" data-i18n="nav.dash.crypto">أضافه
                            جديد</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> الأقسام ألفرعيه</span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('sub-categories.create') }}"
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('vendors.create') }}" data-i18n="nav.dash.crypto">أضافه
                            جديد</a>
                    </li>
                </ul>
            </li>
