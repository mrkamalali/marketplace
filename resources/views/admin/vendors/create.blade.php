                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form" style="color: #9f191f"> إضافة متجر
                                        جديد </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ old('mobile') }}" id="mobile"
                                                                   class="form-control"
                                                                   placeholder="الهاتف المحمول ( مطلوب )"
                                                                   name="mobile">
                                                            @error("mobile")
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
...
@section('script')
    ...
    {{-- Api Google Map --}}
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG async defer">
    </script>
